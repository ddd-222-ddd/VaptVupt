...
$sql = "SELECT NOME, DESC_PROD, PRECO, FOTO FROM PRODUTOS WHERE TIPO = 'combo'";
$res = $conn->query($sql);
...
<body>
    <h1>Cardápio</h1>
    <form action="combos.php" method="post" id="menu-form">
    ...
    <a class="car" href="cardapio.php?page=carrinho">Ver Carrinho</a>
